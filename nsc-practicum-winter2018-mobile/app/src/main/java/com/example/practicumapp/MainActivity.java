...
public class MainActivity extends AppCompatActivity {
    ...
    private void saveLoginData() {
        ...
        sharedPreferences.edit().putString("Name", mResult.getUserInfo().getGivenName() + " " +
                mResult.getUserInfo().getFamilyName()).apply();
    }
    ...
    public void clearLogin(){
        ...
        mResult = null;
        SharedPreferences login = this.getSharedPreferences("LoginInfo", Context.MODE_PRIVATE);
